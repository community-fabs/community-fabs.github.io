...
Our SDK is a modern, [open-source](https://www.github.com/community-fabs/playfab-js-sdk), dependency-free JavaScript SDK for PlayFab that supports Promises, ES Modules, tree-shaking, and custom request middleware.
